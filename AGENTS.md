<!-- for-agents
# This file is generated by `for-agents` (in ~/code/system/for-agents) from its template
# templates/AGENTS.md.vto. Don't edit the generated sections here: change the
# options below or the template, then run `for-agents update .` in this repo.
# Only the options below and the sections between "Programming thoughts" and
# "After making changes" are this project's own; every other section is
# overwritten.

languages       = ["typescript"]
libraries_extra = ["`ventojs` for plain text templating."]
checks          = ["pnpm"]
-->
